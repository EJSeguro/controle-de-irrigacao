            ...
            child: Column(
              ...
              children: [
                Text('Consumo de Água',
                    style: Theme.of(context).textTheme.titleMedium),
                const SizedBox(height: 16),
                _consumoRow(context, 'Hoje', '${system.consumoHoje.toStringAsFixed(1)} L', Icons.today),
                const Divider(),
                _consumoRow(context, 'Este mês', '${system.consumoMes.toStringAsFixed(1)} L', Icons.date_range),
                const Divider(),
                _consumoRow(context, 'Este ano', '${system.consumoAno.toStringAsFixed(1)} L', Icons.calendar_month),
              ],
            ),
          ),
        ),
